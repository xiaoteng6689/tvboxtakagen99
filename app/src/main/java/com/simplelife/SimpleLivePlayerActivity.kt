...
import com.github.tvbox.osc.databinding.ActivitySimpleliveplayerBinding
import com.google.gson.Gson
import com.simplelife.dialog.ChannelListDialog
import com.simplelife.dialog.SettingDialog
 ...
 * @author Potato-66
 */
class SimpleLivePlayerActivity : BaseActivity()  {
    private lateinit var binding: ActivitySimpleliveplayerBinding
    ...
    override fun getLayoutResID(): Int {return R.layout.activity_simpleliveplayer  }
...
//        hideSystemUi()
//        binding = DataBindingUtil.setContentView(this, R.layout.activity_simpleliveplayer)
...
//                val renderersFactory = object : DefaultRenderersFactory(this@SimpleLivePlayerActivity) {
...
//                        }
//                    }
//                exoPlayer = ExoPlayer.Builder(this@SimpleLivePlayerActivity, renderersFactory)
