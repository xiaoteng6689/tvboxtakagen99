...
import com.github.tvbox.osc.databinding.ActivitySimpleliveBinding
 ...
 * @author Potato-66
 */
//class SimpleLiveActivity : AppCompatActivity() {


class SimpleLiveActivity : BaseActivity() {

    override fun getLayoutResID(): Int { return R.layout.activity_simplelive }
//    override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
//        window.addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON)
//        window.addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN)
//        val binding =
//            DataBindingUtil.setContentView(this, R.layout.activity_simplelive) as ActivitySimpleliveBinding
...
//                startActivity(Intent(this@SimpleLiveActivity, SimpleLivePlayerActivity::class.java))
//                finish()
//            }
...
//            }
//            ChannelUtils.parseChannel(this@SimpleLiveActivity)
//            binding.progress.hide()
